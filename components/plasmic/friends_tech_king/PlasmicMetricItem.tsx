...
import sty from "./PlasmicMetricItem.module.css"; // plasmic-import: 8p_4NvAXmxVJ/css
...
function PlasmicMetricItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__c96Up)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(
      ...
      <div className={classNames(projectcss.all, sty.freeBox__koyS9)}>
        {p.renderPlasmicSlot({
