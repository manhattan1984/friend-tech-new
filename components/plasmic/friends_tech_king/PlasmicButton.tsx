...
import sty from "./PlasmicButton.module.css"; // plasmic-import: X48cJgHH48y/css
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_clear_size_minimal]:
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___3SuMb)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainercolor_blue]: hasVariant($state, "color", "blue"),
          [sty.contentContainercolor_clear_size_minimal]:
            hasVariant($state, "size", "minimal") &&
            hasVariant($state, "color", "clear"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___5Fon5)}
                role={"img"}
              />
            ),
