...
import Plan from "../../Plan"; // plasmic-import: R6gMo0vdSGCU/component
import Button2 from "../../Button2"; // plasmic-import: eElla8BSTIjZ/component
import { Fetcher } from "@plasmicapp/react-web/lib/data-sources"; // plasmic-import: lg06MkxP9f2/codeComponent
...
import sty from "./PlasmicPlansPage.module.css"; // plasmic-import: pFW8f1wCp2vn/css
...
function PlasmicPlansPage__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__m3Jn)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox___8Kfhx)}>
            {(
              (() => {
                try {
...
const PlasmicDescendants = {
  root: ["root", "section", "plan", "button2"],
  section: ["section", "plan", "button2"],
  plan: ["plan", "button2"],
  button2: ["button2"]
} as const;
