          ...
          <div className={classNames(projectcss.all, sty.freeBox__bJ57P)}>
            ...
            <Hero
              ...
              ctaButtons2={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__mcrkP)}
                    color={"blue" as const}
                    onClick={async event => {
                      const $steps = {};
                              ...
                              variable: __wrapUserFunction(
                                {
                                  ...
                                  interactionUuid: "SD_W6d_ztdei",
                                  componentUuid: "cKtNscfl8RsZ",
                                  argName: "variable"
                                },
                                () => ({
                                  objRoot: $state,
            ...
            <BenefitSection
              ...
              slot2={
                true ? (
                  <Button
                    className={classNames("__wab_instance", sty.button__oNjoC)}
                    color={"blue" as const}
                    onClick={async event => {
                      const $steps = {};
                      $steps["updateConnectWallet"] = true
