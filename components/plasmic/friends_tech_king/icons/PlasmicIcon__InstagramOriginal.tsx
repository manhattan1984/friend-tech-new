...
export type InstagramOriginalIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function InstagramOriginalIcon(props: InstagramOriginalIconProps) {
...
export default InstagramOriginalIcon;
/* prettier-ignore-end */
